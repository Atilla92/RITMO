...
plot_heatmap = False #Plot sns heatmap and mosaic 
plot_scatterplot = True #Plot a scatterplot of 3 variables
...
if plot_heatmap:
    ...
    heatMapCategories(['Imp_subj', 'Dance_Imp'], True, save_plot)
