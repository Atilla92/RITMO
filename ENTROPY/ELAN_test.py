...
for file_i, file_item_long in enumerate(list_files):
    ...
    #Import files outside of try statement
    ...
    #            print(tR_end.iloc[j],tR_end.iloc[j+1],'TR' ,tI_0.iloc[i], 'TI', tI_1.iloc[i],j, i )
        ...
        #                print('Test5')
            ...
            #Fetching LZ entropy in intervals
                ...
                print('Rating Improv File not found: ', file_item_long )
                #Need to create an empty DFR here, or see whether you can store in two different bathces. 
                pass
            ...
            try:
                ...
                print('File Flow Rating not found:', file_item_long)

                pass
            

            # Try rest of files in one batch


            # Filter out stuff drom dfS, correct file for ratings.
            ...
            try: 
                ...
                print('File During experiments not found ')
                pass
            ...
            try:
                ...
                print('File Entropy not found: ', file_item_long)
