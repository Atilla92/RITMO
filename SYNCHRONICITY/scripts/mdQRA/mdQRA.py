...
def main():
    ...
    df_E_drums = import_energy_file(input_energy, file_name, participant_list[0], body_model, t_step)
    df_E_guitar = import_energy_file(input_energy, file_name, participant_list[1], body_model, t_step)
